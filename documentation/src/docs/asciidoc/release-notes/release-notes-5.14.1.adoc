...
[[release-notes-5.14.1-junit-platform-bug-fixes]]
==== Bug Fixes

* ❓

[[release-notes-5.14.1-junit-platform-deprecations-and-breaking-changes]]
==== Deprecations and Breaking Changes

* ❓

[[release-notes-5.14.1-junit-platform-new-features-and-improvements]]
...
[[release-notes-5.14.1-junit-vintage-bug-fixes]]
==== Bug Fixes

* ❓

[[release-notes-5.14.1-junit-vintage-deprecations-and-breaking-changes]]
==== Deprecations and Breaking Changes

* ❓

[[release-notes-5.14.1-junit-vintage-new-features-and-improvements]]
==== New Features and Improvements
