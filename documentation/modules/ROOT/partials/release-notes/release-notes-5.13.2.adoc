...
[[v5.13.2-junit-platform]]
=== JUnit Platform

[[v5.13.2-junit-platform-bug-fixes]]
==== Bug Fixes
...
[[v5.13.2-junit-platform-deprecations-and-breaking-changes]]
...
* Including information about the Git repository (such as the commit hash and branch name)
  ...
  xref:advanced-topics/junit-platform-reporting.adoc#open-test-reporting[User Guide]
  for details.


[[v5.13.2-junit-jupiter]]
=== JUnit Jupiter

[[v5.13.2-junit-jupiter-bug-fixes]]
==== Bug Fixes
