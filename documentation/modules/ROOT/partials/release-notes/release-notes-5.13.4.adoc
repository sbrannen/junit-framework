...
[[v5.13.4-overall-improvements]]
=== Overall Changes

[[v5.13.4-overall-new-features-and-improvements]]
...
[[v5.13.4-junit-platform]]
=== JUnit Platform

[[v5.13.4-junit-platform-bug-fixes]]
==== Bug Fixes
...
[[v5.13.4-junit-jupiter]]
=== JUnit Jupiter

[[v5.13.4-junit-jupiter-new-features-and-improvements]]
==== New Features and Improvements
