...
example, in `junit-platform.properties` (see xref:running-tests/configuration-parameters.adoc[] for other
options).
...
[source,java]
----
include::example$java/example/ExplicitExecutionModeDemo.java[]
----
