...
use the xref:running-tests/console-launcher.adoc[] manually -- for example, from the command line
-- or execute tests with a xref:running-tests/using-junit-4-to-run-the-junit-platform.adoc[JUnit 4 based Runner] if
