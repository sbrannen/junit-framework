 ...
 *
 * @since 6.0
 * @see org.junit.platform.commons.support.ReflectionSupport#findAllResourcesInClasspathRoot(URI, java.util.function.Predicate)
 * @see org.junit.platform.commons.support.ReflectionSupport#findAllResourcesInPackage(String, java.util.function.Predicate)
 * @see org.junit.platform.commons.support.ReflectionSupport#findAllResourcesInModule(String, java.util.function.Predicate)
 * @see org.junit.platform.commons.support.ReflectionSupport#streamAllResourcesInClasspathRoot(URI, java.util.function.Predicate)
 * @see org.junit.platform.commons.support.ReflectionSupport#streamAllResourcesInPackage(String, java.util.function.Predicate)
 * @see org.junit.platform.commons.support.ReflectionSupport#streamAllResourcesInModule(String, java.util.function.Predicate)
 */
