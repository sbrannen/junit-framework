...
class ReflectionSupportTests {
	...
	void loadClassPreconditions() {
		assertPreconditionViolationNotNullOrBlankFor("Class name", () -> ReflectionSupport.loadClass(null));
		assertPreconditionViolationNotNullOrBlankFor("Class name", () -> ReflectionSupport.loadClass(""));
	}
